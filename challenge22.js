(function() {
  ...
  console.log(getFullName.call(wendell));
  console.log(getFullName.call(erika));
  ...
  */
  ...
  console.log(sum(7, 6, 8));
  console.log(sum(10, 200, 200));
  ...
  */
  ...
  var numbers = jusNumbers(userEntry);
  console.log(numbers);
